    ...
    public: {
        Tables: {
            ...
            wallet_defi: {
                ...
                Relationships: [
                    {
                        foreignKeyName: 'wallet_defi_token_id_fkey'
                        columns: ['token_id']
                        isOneToOne: false
                        referencedRelation: 'tokens_registry'
                        referencedColumns: ['id']
                    ...
                    {
                        foreignKeyName: 'wallet_defi_wallet_id_fkey'
                        columns: ['wallet_id']
                        isOneToOne: false
                        referencedRelation: 'wallets'
                        referencedColumns: ['id']
            ...
            wallet_nfts: {
                ...
                Relationships: [
                    {
                        foreignKeyName: 'wallet_nfts_token_registry_id_fkey'
                        columns: ['token_registry_id']
                        isOneToOne: false
                        referencedRelation: 'tokens_registry'
                        referencedColumns: ['id']
                    },
                    {
                        foreignKeyName: 'wallet_nfts_wallet_id_fkey'
                        columns: ['wallet_id']
                        isOneToOne: false
                        referencedRelation: 'wallets'
                        referencedColumns: ['id']
